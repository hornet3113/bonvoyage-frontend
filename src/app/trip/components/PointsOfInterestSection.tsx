  ...
  return (
    <div className="px-4 max-w-7xl mx-auto pt-6 pb-8 space-y-4">
      ...
      <div className="flex gap-5 items-start">
        ...
        <div className="flex-1 min-w-0 overflow-y-auto max-h-[calc(100vh-220px)] pr-1">
          {filtered.length === 0 ? (
        ...
        <div className="w-[420px] flex-shrink-0 sticky top-[72px] h-[calc(100vh-180px)] flex flex-col gap-3">
              ...
              <div className="flex gap-3">
                ...
                <div className="flex-1 min-w-0 p-3 space-y-1.5">
                  ...
                  {selectedPlace.description && (
                    <p className="text-[10px] text-gray-600 leading-relaxed line-clamp-2">{selectedPlace.description}</p>
                  )}
      ...
      <div className="relative w-full h-44 bg-gray-100 overflow-hidden">
        ...
        {poi.priceLevel && (
          <div className="absolute bottom-2 right-2 flex items-center gap-0.5 bg-white/90 backdrop-blur-sm rounded-full px-2 py-0.5 shadow-sm">
            ...
            <span className="text-[10px] font-semibold text-gray-700">{poi.priceLevel}</span>
          </div>
        )}
